...
```
Answer: the africa is the most density continent and the south america is the 
...
Answer here: Because here we represent (continents), not just color control, as the colors here belong to the continents, and also the filling is related to the continents But the Alpha it's Graphic ( geno_density )
...
```
answer:box plots provide a coarser summary of the data, provide more of a summary of a distribution can also be seen as an advantage in certain cases, also the point_in the graph or mapping it's most clearly Than Violin plots
...
ggplot(data = plastic_waste,
     ...
     geom_point()
```
Answer : Europe ( Positive ) relationship, Africa is the most (mismanged - plastic watse per cap)
